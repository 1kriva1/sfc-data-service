...
//        // Assert
//        Assert.NotNull(assertedServices.FirstOrDefault(s => s.ImplementationType == typeof(RequireDataConsumerDefinition)));
//        Assert.NotNull(assertedServices.FirstOrDefault(s => s.ImplementationType == typeof(RequireDataConsumer)));
//    }
