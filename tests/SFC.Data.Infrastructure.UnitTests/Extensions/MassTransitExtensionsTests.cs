...
public class MassTransitExtensionsTests
{
    ...
    public void Extension_MassTransit_ShouldRegisterConsumerWithDefinition()
    {
        ...
        // Assert
        Assert.NotNull(assertedServices.FirstOrDefault(s => s.ImplementationType == typeof(DataRequireMessageDefinition)));
        Assert.NotNull(assertedServices.FirstOrDefault(s => s.ImplementationType == typeof(DataRequireMessageConsumer)));
    }
    ...
    {
        // Arrange
        DataInitiator initiator = DataInitiator.Init;
        string key = "data";
