...
//        dataServiceMock.Setup(r => r.GetAllDataAsync()).Verifiable();
...
//        // Assert
//        dataServiceMock.Verify(mock => mock.GetAllDataAsync(), Times.Once());
//    }
...
//        // Assert
//        dataServiceMock.Verify(mock => mock.GetAllDataAsync(), Times.Never());
//    }
//}